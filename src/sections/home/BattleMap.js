...
const CaseStyle = styled('div')(() => ({
    ...
    '&:after': {
        ...
        bottom: '-42px',
        left: '0',
        background: 'url(images/battle-map/case-arrow.png) 0 0 no- repeat',
        zIndex: 3
    }
}
));
            ...
            <Box sx={{ position: 'relative', textAlign: 'center' }}>
                ...
                {isDesktop ?
                    <Box sx={{ position: 'relative' }}>
                        ...
                        >
                            <PinItem />
                            <CaseItem caseClass="case1" title="Earn Bells" image="images/battle-map/in-game-activities.png" description="Fight creeps and destroy them to earn bells" />
                        </Box>
                        ...
                        <Box sx={{
                            ...
                            <PinItem />
                            <CaseItem caseClass="case2" title="Townhall" image="images/battle-map/upgrade.png" description="Spawn point for your team. generate health" />
                        </Box>
                        ...
                        <Box sx={{
                            ...
                            <PinItem />
                            <CaseItem caseClass="case3" title="Towers" image="images/road-map/road-map7.png" description="Destroy all enemy towers with the bells earned to win the game" />
                        </Box>
